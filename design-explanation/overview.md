...
- TODO: translate this markdown into a block diagram
- Notes regarding motherboard design choices and hardware specs

## Component Overview

![motherboard-components](_images/overview/motherboard-components.drawio.png)
...
13. IR Sensors
    ...
    - output constrained to 0~2V5 w/ a voltage divider to adhere to MCU's ADC pin limit
